 ...
 * 
 */
@WebServiceClient(name = "travelGoodService", targetNamespace = "urn://travelGood", wsdlLocation = "http://localhost:9080/TravelGood/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TRAVELGOODSERVICE_QNAME = new QName("urn://travelGood", "travelGoodService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9080/TravelGood/service?wsdl");
    ...
    public TravelGoodPortType getTravelGoodPortTypeBindingPort() {
        return super.getPort(new QName("urn://travelGood", "travelGoodPortTypeBindingPort"), TravelGoodPortType.class);
    }
    ...
    public TravelGoodPortType getTravelGoodPortTypeBindingPort(WebServiceFeature... features) {
        return super.getPort(new QName("urn://travelGood", "travelGoodPortTypeBindingPort"), TravelGoodPortType.class, features);
    }
